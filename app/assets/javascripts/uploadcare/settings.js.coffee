...
namespace 'uploadcare.settings', (ns) ->
  ...
  defaults =
    ...
    'multiple-min': 1
    'path-value': false
    'tabs': 'file url facebook gdrive dropbox instagram evernote flickr skydrive box'
    'preferred-types': ''
  ...
  presets =
    'tabs':
      all: 'file url facebook gdrive dropbox instagram evernote flickr skydrive box vk'
