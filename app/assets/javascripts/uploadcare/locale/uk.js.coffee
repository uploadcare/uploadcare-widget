...
uploadcare.namespace 'locale.translations', (ns) ->
    ns.uk =
        ...
        errors:
            ...
            image: 'Дозволено лише зображення'
            createGroup: 'Неможливо створити групу файлів'
            deleted: 'Файл видалений'
        ...
        camera:
            ...
            stopRecord: 'Стоп'
            cancelRecord: 'Скасування'
            retry: 'Повторний запит дозволу'
        pleaseAllow:
            title: 'Будь ласка надайте доступ до вашої камери'
            text: 'Вам буде запропоновано дозволити доступ до камери з цього сайту.<br>' +
        ...
        text: 'Повторіть спробу з іншого файлу.'
