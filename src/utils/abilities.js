...
// utils.abilities
const fileAPI = isWindowDefined() && !!(window.File && window.FileList && window.FileReader)
...
const dragAndDrop = isWindowDefined() && (function () {
  var el
...
const canvas = isWindowDefined() && (function () {
  var el
...
const ios = isWindowDefined() && /^[^(]+\(iP(?:hone|od|ad);\s*(.+?)\)/.exec(navigator.userAgent)
...
const FileReader =
  isWindowDefined() && ((window.FileReader != null
